...
<div class="pmpro-wizard">
	<div style="background-image: url('/wp-content/plugins/paid-memberships-pro/images/bg_icons-white.png');background-repeat: repeat;background-size: 50%;position: absolute; top: 0; left: 0; width: 100%;height: 100%;opacity: .5; z-index: -1;"></div>
			...
			<div class="pmpro-wizard__step pmpro-wizard__step-1">
				...
				<div class="pmpro-wizard__field">
					<label class="pmpro-wizard__label-block">
						...
						<?php esc_html_e( 'Generate the required plugin pages for me.', 'paid-memberships-pro' ); ?>
					</label>
				</div>
				<div class="pmpro-wizard__field">
					<label class="pmpro-wizard__label-block">
